...
public class conexionBD {
    ...
    private static final String BD = "base";
    ...
    public static proyecto.proyecto.BD.conexionBD getInstance() {
        return AccesoBaseDatosHolder.INSTANCE;
    }

    private static class AccesoBaseDatosHolder {

        private static final proyecto.proyecto.BD.conexionBD INSTANCE = new proyecto.proyecto.BD.conexionBD();
    }
